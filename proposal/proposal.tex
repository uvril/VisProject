...
If we simply want to show the information for some country in some year, the first three parts are already sufficient.
However, the challenging thing is to show aggregation data.
In below, we designed three alternative designs for aggregation data:
